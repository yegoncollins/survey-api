...
public class SurveySummaryEntity {
    ...
    public SurveySummaryEntity(Long survey_summary_id, SurveysEntity survey_id, Integer number_of_questions, Integer number_of_responses, Integer number_of_pages, Date date_created, Date date_modified) {
